        ...
        for enemy in enemys4:  # Сражение с врагами
            if fight_anime_count == 5 and repeat_fight_anim == 2:
                if keys[pygame.K_w] and keys[pygame.K_e] and 0 <= player_y - enemy.enemy_pos_y <= 60 and abs(player_x - enemy.enemy_pos_x) <= 50:
                    enemy.hp -= 0.5
                elif keys[pygame.K_a] and keys[pygame.K_e] and abs(player_y - enemy.enemy_pos_y) <= 50 and 0 <= player_x - enemy.enemy_pos_x <= 50:
                    enemy.hp -= 0.5
                elif keys[pygame.K_s] and keys[pygame.K_e] and 0 <= enemy.enemy_pos_y - player_y <= 60 and abs(player_x - enemy.enemy_pos_x) <= 50:
                    enemy.hp -= 0.5
                elif keys[pygame.K_d] and keys[pygame.K_e] and abs(player_y - enemy.enemy_pos_y) <= 50 and 0 <= enemy.enemy_pos_x - player_x <= 50:
                    enemy.hp -= 0.5
                if enemy.hp == 0:
                    enemy.alive = 0
